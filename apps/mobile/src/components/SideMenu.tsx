...
const styles = StyleSheet.create({
  ...
  panelTitle: { fontFamily: tokens.typography.rnFonts.bodySemibold, fontSize: 16, fontWeight: '600', color: tokens.colors.fg },
  profileHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  ...
  profileName: { fontFamily: tokens.typography.rnFonts.bodySemibold, fontSize: 17, fontWeight: '600', color: tokens.colors.fg },
  profileHandle: { fontFamily: tokens.typography.rnFonts.mono, fontSize: 12, color: 'rgba(241,235,224,0.5)', marginTop: 2 },
  ...
  menuRowText: { fontFamily: tokens.typography.rnFonts.body, fontSize: 15.5, color: tokens.colors.fg },
  ...
  empty: { fontFamily: tokens.typography.rnFonts.body, fontSize: 13, color: 'rgba(241,235,224,0.4)', marginBottom: 8 },
  ...
  addBtnText: { fontFamily: tokens.typography.rnFonts.bodySemibold, fontSize: 14, fontWeight: '600', color: tokens.colors.nearBlack },
  addMsg: { fontFamily: tokens.typography.rnFonts.body, fontSize: 12.5, marginTop: 8 },
  shareProfileBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  shareProfileText: { fontFamily: tokens.typography.rnFonts.bodySemibold, fontSize: 14, fontWeight: '600' },
  ...
  personName: { fontFamily: tokens.typography.rnFonts.bodySemibold, fontSize: 14, fontWeight: '600', color: tokens.colors.fg },
  personHandle: { fontFamily: tokens.typography.rnFonts.mono, fontSize: 11, color: 'rgba(241,235,224,0.45)' },
  ...
  reqBtnText: { fontFamily: tokens.typography.rnFonts.bodySemibold, fontSize: 12.5, fontWeight: '600', color: tokens.colors.nearBlack },
  fieldLabel: {
    fontFamily: tokens.typography.rnFonts.mono,
    fontSize: 10.5,
    letterSpacing: 1.2,
