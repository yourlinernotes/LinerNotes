...
function OnboardingContent() {
  ...
  // Jump to the connect step when returning from Last.fm OAuth.
  useEffect(() => {
    if (searchParams.get("lastfm_connected") === "true") setStep(2);
  }, [searchParams]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Step 2: How do you listen? — shared chooser (no cookie paste) */}
        {step === 2 && (
          <>
            ...
            <ListeningConnect lastfmCallbackUrl="/onboarding" />

            <button onClick={finishOnboarding} style={{ width: "100%", background: "transparent", color: muted(0.85), border: `1px solid ${LINE}`, borderRadius: 14, padding: "15px 20px", fontFamily: "var(--ln-body)", fontSize: 15.5, fontWeight: 600, cursor: "pointer", marginTop: 16 }}>
              Continue to LinerNotes
            </button>
          </>
        )}
      </div>
